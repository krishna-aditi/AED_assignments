...
public class ManageDeliveryMenJPanel extends javax.swing.JPanel {
    ...
    public ManageDeliveryMenJPanel(JPanel userProcessContainer, UserAccount userAccount) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblOrganizationList1.setText("New Delivery Agent:");
        ...
        lblTitle.setText("Manage Delivery Agents");
    ...
    private void btnCreateEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateEmployeeActionPerformed
        ...
        populateDeliveryAgentTable(restaurant);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        DeliveryMan selectedAgent = (DeliveryMan) viewModel.getValueAt(selectedRowIndex, 0); // typecasting to Patient class type
        // at the 0th column we have the whole object stored

        restaurant.getDeliveryManDir().removeDeliveryMan(selectedAgent);
        JOptionPane.showMessageDialog(this, "Patient log deleted!");

        populateDeliveryAgentTable(restaurant); // refreshing table after deletion
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        DeliveryMan selectedAgent = (DeliveryMan) updateModel.getValueAt(selectedRowIndex, 0); // typecasting to Patient class type

        selectedAgent.setName(txtEmployeeName.getText());
    ...
    private void populateDeliveryAgentTable(Restaurant restaurant) {
        DefaultTableModel model = (DefaultTableModel) tblEmployees.getModel();
        
        model.setRowCount(0);

        for (DeliveryMan deliveryMan : restaurant.getDeliveryManDir().getEmployeeList()){
